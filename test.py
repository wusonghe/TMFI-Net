    ...
    for dname in list_indata:
        ...
        for i in range(len(list_frames)):
            ...
            if i >= len_temporal - 1:  # 够32帧后才能处理
                ...
                del snippet[0]  # 通过每次删除第一帧来保持snippet=32帧
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--path_indata', default='E:/VSPdateset/DHF1K1', type=str)
    parser.add_argument('--path_indata', default='E:/VSPdateset/DHF1K9', type=str)
